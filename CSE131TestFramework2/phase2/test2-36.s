...
arrayEnd_6:
/* line number 17*/
/* printing float STO.ExprSTO@5b04ae */
    set         -200, %l1
    add         %fp, %l1, %l1
    ld          [%l1], %l1
    ld          [%l1], %f0
...
arrayEnd_7:
/* line number 17*/
/* printing float STO.ExprSTO@1904b13 */
    set         -204, %l1
    add         %fp, %l1, %l1
    ld          [%l1], %l1
    ld          [%l1], %f0
...
/* Done printing string. */
/* line number 17*/
/* printing float STO.VarSTO@10d3d99 */
    set         -12, %l1
    add         %fp, %l1, %l1
    ld          [%l1], %f0
    call    printFloat
...
arrayEnd_14:
/* line number 21*/
/* printing float STO.ExprSTO@19db21f */
    set         -232, %l1
    add         %fp, %l1, %l1
    ld          [%l1], %l1
    ld          [%l1], %f0
...
arrayEnd_15:
/* line number 21*/
/* printing float STO.ExprSTO@191a42 */
    set         -236, %l1
    add         %fp, %l1, %l1
    ld          [%l1], %l1
    ld          [%l1], %f0
