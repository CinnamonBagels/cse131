...
/* Done. */
/* line number 22*/
/* printing float STO.VarSTO@da18ac */
    set         shakespeare, %l1
    add         %g0, %l1, %l1
    ld          [%l1], %f0
    call    printFloat
...
/* Done printing float. */
    ...
    nop
/* line number 23*/
/* printing float STO.VarSTO@b30913 */
    set         marlowe, %l1
    add         %g0, %l1, %l1
    ld          [%l1], %f0
    call    printFloat
...
/* Done printing float. */
    ...
    nop
/* line number 24*/
/* printing float STO.VarSTO@18f51f */
    set         goethe, %l1
    add         %g0, %l1, %l1
    ld          [%l1], %f0
    call    printFloat
...
/* Done printing float. */
    ...
    nop
/* line number 25*/
/* printing float STO.VarSTO@84ce7a */
    set         shelley, %l1
    add         %g0, %l1, %l1
    ld          [%l1], %f0
    call    printFloat
...
/* Done printing float. */
    ...
    nop
/* line number 29*/
/* printing float STO.VarSTO@1035079 */
    set         -80, %l1
    add         %fp, %l1, %l1
    ld          [%l1], %f0
    call    printFloat
